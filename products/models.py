...
class Product(PolymorphicModel):
    ...
    host_creators = models.ManyToManyField(User,
                                           related_name='product_creators',
                                           blank=True)
...
class Workshop(Product):
    ...
    attendance = models.ManyToManyField(
        User, related_name='workshop_attendees', blank=True)
...
class DigitalProduct(Product):
    ...
    owners = models.ManyToManyField(
        User, related_name='resource_owners', blank=True)
